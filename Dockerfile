...
# prisma/schema.prisma is needed here because package.json's postinstall runs `prisma generate`
...
# NEXTAUTH_URL is a runtime value — placeholder keeps new URL() valid during build
