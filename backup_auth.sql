...
--
-- Name: LoginHistory; Type: TABLE; Schema: public; Owner: gex_user
--
...
--
-- Name: User; Type: TABLE; Schema: public; Owner: gex_user
--
...
--
-- Name: _prisma_migrations; Type: TABLE; Schema: public; Owner: gex_user
--
...
--
-- Data for Name: LoginHistory; Type: TABLE DATA; Schema: public; Owner: gex_user
--
...
--
-- Data for Name: User; Type: TABLE DATA; Schema: public; Owner: gex_user
--
...
--
-- Data for Name: _prisma_migrations; Type: TABLE DATA; Schema: public; Owner: gex_user
--
...
--
-- Name: LoginHistory LoginHistory_pkey; Type: CONSTRAINT; Schema: public; Owner: gex_user
--
...
--
-- Name: User User_pkey; Type: CONSTRAINT; Schema: public; Owner: gex_user
--
...
--
-- Name: _prisma_migrations _prisma_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: gex_user
--
...
--
-- Name: User_email_key; Type: INDEX; Schema: public; Owner: gex_user
--
...
--
-- Name: LoginHistory LoginHistory_userId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: gex_user
--
