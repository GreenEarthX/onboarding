        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <a href="http://localhost:3000/auth/verify?token=${token}" class="button">Verify Email</a>
              <p>If the button doesn't work, copy and paste this link into your browser:</p>
              <p><a href="http://localhost:3000/auth/verify?token=${token}">http://localhost:3000/auth/verify?token=${token}</a></p>
            </div>
            <div class="footer">
